(* variant of query.ml: modules anotated with [@@InjectTypes  ] will be injected with all types synthesized up to that point. 
    Like the second variant but with more magic
*)
...
module QueryImpls [@InjectSynthesizedTypes] = (* alternatively: module%injecttypes QueryImpls = ... *)
struct
(*
    let query_typecheck
